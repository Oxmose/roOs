...
#define EXCEPTIONS_DEBUG_ENABLED 1
#define INTERRUPTS_DEBUG_ENABLED 1
#define IOAPIC_DEBUG_ENABLED 1
#define KHEAP_DEBUG_ENABLED 1
#define KICKSTART_DEBUG_ENABLED 1
#define LAPIC_DEBUG_ENABLED 1
#define MEMMGT_DEBUG_ENABLED 1
#define PIC_DEBUG_ENABLED 1
#define PIT_DEBUG_ENABLED 1
#define QUEUE_DEBUG_ENABLED 1
#define KQUEUE_DEBUG_ENABLED 1
#define RTC_DEBUG_ENABLED 1
#define SCHED_DEBUG_ENABLED 1
#define SCHED_ELECT_DEBUG_ENABLED 1
#define SCHED_SWITCH_DEBUG_ENABLED 1
#define SERIAL_DEBUG_ENABLED 1
#define TIME_MGT_DEBUG_ENABLED 1
#define VGA_DEBUG_ENABLED 1
#define SYSCALL_DEBUG_ENABLED 1
#define INITRD_DEBUG_ENABLED 1
#define USTAR_DEBUG_ENABLED 1
#define MUTEX_DEBUG_ENABLED 1
#define TEMP_DEBUG_ENABLED 1
#define USER_HEAP_DEBUG_ENABLED 1
#define SEMAPHORE_DEBUG_ENABLED 1
