...
#ifndef __X86_VGA_CONSOLE_H_
#define __X86_VGA_CONSOLE_H_
 ...
 */
void vga_console_scroll(const SCROLL_DIRECTION_E direction,
...
/**
 * @brief Returns the VGA console driver.
 *
 * @details Returns a constant handle to the VGA console driver.
 *
 * @return A constant handle to the VGA console driver is returned.
 */
const kernel_console_driver_t* vga_console_get_driver(void);


#endif /* #ifndef __X86_VGA_CONSOLE_H_ */
