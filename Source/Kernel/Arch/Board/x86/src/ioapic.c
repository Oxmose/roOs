...
static void _ioapicSetIrqMask(const uint32_t kIrqNumber, const bool_t kEnabled)
{
    ...
    KERNEL_TRACE_EVENT(TRACE_X86_IOPIC_ENABLED,
                       TRACE_X86_IOPIC_SET_IRQ_MASK_ENTRY,
                       2,
                       kIrqNumber,
                       (uint32_t)kEnabled);
    ...
    KERNEL_TRACE_EVENT(TRACE_X86_IOPIC_ENABLED,
                       TRACE_X86_IOPIC_SET_IRQ_MASK_EXIT,
                       2,
                       kIrqNumber,
                       (uint32_t)kEnabled);
}
...
#ifdef ARCH_32_BITS
    KERNEL_TRACE_EVENT(TRACE_X86_IOPIC_ENABLED,
                       TRACE_X86_IOPIC_SET_IRQ_MASK_FOR_ENTRY,
                       4,
                       0,
                       (uint32_t)pCtrl,
                       kIrqNumber,
...
#ifdef ARCH_32_BITS
    KERNEL_TRACE_EVENT(TRACE_X86_IOPIC_ENABLED,
                       TRACE_X86_IOPIC_SET_IRQ_MASK_FOR_EXIT,
                       4,
                       0,
                       (uint32_t)pCtrl,
                       kIrqNumber,
...
static INTERRUPT_TYPE_E _ioapicHandleSpurious(const uint32_t kIntNumber)
{
    ...
    KERNEL_TRACE_EVENT(TRACE_X86_IOPIC_ENABLED,
                       TRACE_X86_IOPIC_HANDLE_SPURIOUS_ENTRY,
                       1,
                       kIntNumber);
    ...
    if(kIntNumber == SPURIOUS_INT_LINE)
    {
    ...
    KERNEL_TRACE_EVENT(TRACE_X86_IOPIC_ENABLED,
                       TRACE_X86_IOPIC_HANDLE_SPURIOUS_EXIT,
                       2,
                       kIntNumber,
                       intType);
