...
#define TEST_queueCreateNode0_ID  4000
#define TEST_queueCreateNode1_ID  4001
#define TEST_queueCreateNode2_ID  4002
#define TEST_queueCreateNode3_ID  4003
#define TEST_queueDeleteNode0_ID  4004
#define TEST_queueDeleteNode1_ID  4005
#define TEST_queueDeleteNode2_ID  4006
#define TEST_queueDeleteNode3_ID  4007
#define TEST_queueCreate0_ID 4008
#define TEST_queueCreate1_ID 4009
#define TEST_queueCreate2_ID 4010
#define TEST_queueCreate3_ID 4011
#define TEST_queueCreate4_ID 4012
#define TEST_queueDelete0_ID 4013
#define TEST_queueDelete1_ID 4014
#define TEST_queueDelete2_ID 4015
#define TEST_queueDelete3_ID 4016
#define TEST_queueDelete4_ID 4017
#define TEST_queueDelete5_ID 4018
...
#define TEST_queueCreateNodeBURST0_ID(IDVAL) (4035 + IDVAL)
#define TEST_queueCreateNodeBURST1_ID(IDVAL) \
    (TEST_queueCreateNodeBURST0_ID(80) + IDVAL)
#define TEST_QUEUE_PUSHPRIOBURST0_ID(IDVAL)\
    (TEST_queueCreateNodeBURST1_ID(80) + IDVAL)
...
#define TEST_KqueueCreateNode0_ID             5000
#define TEST_KqueueCreateNode1_ID             5001
#define TEST_KqueueDeleteNode0_ID             5002
#define TEST_KqueueCreate0_ID            5003
#define TEST_KqueueCreate1_ID            5004
#define TEST_KqueueDelete0_ID            5005
#define TEST_KqueueDelete1_ID            5006
...
#define TEST_KqueueCreateNodeBURST0_ID(IDVAL) (5015 + IDVAL)
#define TEST_KqueueCreateNodeBURST1_ID(IDVAL) \
    (TEST_KqueueCreateNodeBURST0_ID(40) + IDVAL)
#define TEST_KQUEUE_PUSHPRIOBURST0_ID(IDVAL) \
    (TEST_KqueueCreateNodeBURST1_ID(40) + IDVAL)
