...
typedef enum
{
    ...
    TRACE_X86_UART_WRITE_ENTRY                                          = 394,
    TRACE_X86_UART_WRITE_EXIT                                           = 395,
    TRACE_X86_UART_CLEAR_ENTRY                                          = 396,
    TRACE_X86_UART_CLEAR_EXIT                                           = 397,
    TRACE_X86_UART_SCROLL_ENTRY                                         = 398,
    TRACE_X86_UART_SCROLL_EXIT                                          = 399,
    TRACE_X86_UART_PUTSTRING_ENTRY                                      = 400,
    TRACE_X86_UART_PUTSTRING_EXIT                                       = 401,
    TRACE_X86_UART_PUTCHAR_ENTRY                                        = 402,
    TRACE_X86_UART_PUTCHAR_EXIT                                         = 403,
    TRACE_X86_UART_INTERRUPT_HANDLER_ENTRY                              = 404,
    TRACE_X86_UART_INTERRUPT_HANDLER_EXIT                               = 405,
    TRACE_X86_UART_READ_ENTRY                                           = 406,
    TRACE_X86_UART_READ_EXIT                                            = 407,
    TRACE_X86_UART_SET_ECHO                                             = 408,

    TRACE_EXCEPTION_DIVBYZERO_ENTRY                                     = 408,
    TRACE_EXCEPTION_DIVBYZERO_EXIT                                      = 409,
    TRACE_EXCEPTION_INVALID_INSTRUCTION_ENTRY                           = 411,
    TRACE_EXCEPTION_INVALID_INSTRUCTION_EXIT                            = 412,
    TRACE_EXCEPTION_DEBUG_EXC_ENTRY                                     = 413,
    TRACE_EXCEPTION_DEBUG_EXC_EXIT                                      = 414,
    TRACE_EXCEPTION_BREAKPOINT_EXC_ENTRY                                = 415,
    TRACE_EXCEPTION_BREAKPOINT_EXC_EXIT                                 = 416,
    TRACE_EXCEPTION_OVERFLOW_EXC_ENTRY                                  = 417,
    TRACE_EXCEPTION_OVERFLOW_EXC_EXIT                                   = 418,
    TRACE_EXCEPTION_BOUNDRANGE_EXCEEDED_EXC_ENTRY                       = 419,
    TRACE_EXCEPTION_BOUNDRANGE_EXCEEDED_EXC_EXIT                        = 420,
    TRACE_EXCEPTION_DEV_NOT_AVAIL_EXC_ENTRY                             = 421,
    TRACE_EXCEPTION_DEV_NOT_AVAIL_EXC_EXIT                              = 422,
    TRACE_EXCEPTION_DOUBLE_FAULT_EXC_ENTRY                              = 423,
    TRACE_EXCEPTION_DOUBLE_FAULT_EXC_EXIT                               = 424,
    TRACE_EXCEPTION_COPROC_SEGMENT_OVERRUN_EXC_ENTRY                    = 425,
    TRACE_EXCEPTION_COPROC_SEGMENT_OVERRUN_EXC_EXIT                     = 426,
    TRACE_EXCEPTION_INVALID_TSS_EXC_ENTRY                               = 427,
    TRACE_EXCEPTION_INVALID_TSS_EXC_EXIT                                = 428,
    TRACE_EXCEPTION_SEGMENT_NOT_PRESENT_EXC_ENTRY                       = 429,
    TRACE_EXCEPTION_SEGMENT_NOT_PRESENT_EXC_EXIT                        = 430,
    TRACE_EXCEPTION_STACK_SEGMENT_EXC_ENTRY                             = 431,
    TRACE_EXCEPTION_STACK_SEGMENT_EXC_EXIT                              = 432,
    TRACE_EXCEPTION_GENERAL_PROTECTION_FAULT_EXC_ENTRY                  = 433,
    TRACE_EXCEPTION_GENERAL_PROTECTION_FAULT_EXC_EXIT                   = 434,
    TRACE_EXCEPTION_ALIGNEMENT_CHECK_EXC_ENTRY                          = 435,
    TRACE_EXCEPTION_ALIGNEMENT_CHECK_EXC_EXIT                           = 436,
    TRACE_EXCEPTION_MACHINE_CHECK_EXC_ENTRY                             = 437,
    TRACE_EXCEPTION_MACHINE_CHECK_EXC_EXIT                              = 438,
    TRACE_EXCEPTION_SIMD_FP_EXC_ENTRY                                   = 439,
    TRACE_EXCEPTION_SIMD_FP_EXC_EXIT                                    = 440,
    TRACE_EXCEPTION_VIRTUALIZATION_EXC_ENTRY                            = 441,
    TRACE_EXCEPTION_VIRTUALIZATION_EXC_EXIT                             = 442,
    TRACE_EXCEPTION_CONTROL_PROT_EXC_ENTRY                              = 443,
    TRACE_EXCEPTION_CONTROL_PROT_EXC_EXIT                               = 444,
    TRACE_EXCEPTION_HYPERVISOR_INJECTION_EXC_ENTRY                      = 445,
    TRACE_EXCEPTION_HYPERVISOR_INJECTION_EXC_EXIT                       = 446,
    TRACE_EXCEPTION_VMM_COMM_EXC_ENTRY                                  = 447,
    TRACE_EXCEPTION_VMM_COMM_EXC_EXIT                                   = 448,
    TRACE_EXCEPTION_SECUTIRY_EXC_ENTRY                                  = 449,
    TRACE_EXCEPTION_SECUTIRY_EXC_EXIT                                   = 450,

    TRACE_X86_CPU_CREATE_KERNEL_STACK_ENTRY                             = 451,
    TRACE_X86_CPU_CREATE_KERNEL_STACK_EXIT                              = 452,
    TRACE_X86_CPU_DESTROY_KERNEL_STACK_ENTRY                            = 453,
    TRACE_X86_CPU_DESTROY_KERNEL_STACK_EXIT                             = 454,
    TRACE_X86_CPU_CREATE_VCPU_ENTRY                                     = 455,
    TRACE_X86_CPU_CREATE_VCPU_EXIT                                      = 456,
    TRACE_X86_CPU_DESTROY_VCPU_ENTRY                                    = 457,
    TRACE_X86_CPU_DESTROY_VCPU_EXIT                                     = 458,
    TRACE_X86_CPU_REDIRECT_EXEC_ENTRY                                   = 459,
    TRACE_X86_CPU_REDIRECT_EXEC_EXIT                                    = 460,
    TRACE_X86_CPU_REGISTER_EXC_ENTRY                                    = 461,
    TRACE_X86_CPU_REGISTER_EXC_EXIT                                     = 462,
    TRACE_X86_CPU_MANAGE_THREAD_EXC                                     = 463,

    TRACE_SHEDULER_TERMINATE_THREAD_ENTRY                               = 464,
    TRACE_SHEDULER_TERMINATE_THREAD_EXIT                                = 465,

    TRACE_SIGNAL_HANDLE_KILL_ENTRY                                      = 466,
    TRACE_SIGNAL_HANDLE_KILL_EXIT                                       = 467,
    TRACE_SIGNAL_HANDLE_SEGFAULT_ENTRY                                  = 468,
    TRACE_SIGNAL_HANDLE_SEGFAULT_EXIT                                   = 469,
    TRACE_SIGNAL_HANDLE_FPE_ENTRY                                       = 470,
    TRACE_SIGNAL_HANDLE_FPE_EXIT                                        = 471,
    TRACE_SIGNAL_HANDLE_ILLEGAL_INST_ENTRY                              = 472,
    TRACE_SIGNAL_HANDLE_ILLEGAL_INST_EXIT                               = 473,
    TRACE_SIGNAL_HANDLE_EXCEPTION_ENTRY                                 = 474,
    TRACE_SIGNAL_HANDLE_EXCEPTION_EXIT                                  = 475,
    TRACE_SIGNAL_INIT_SIGNALS_ENTRY                                     = 476,
    TRACE_SIGNAL_INIT_SIGNALS_EXIT                                      = 477,
    TRACE_SIGNAL_MANAGE_SIGNALS_ENTRY                                   = 478,
    TRACE_SIGNAL_MANAGE_SIGNALS_EXIT                                    = 479,
    TRACE_SIGNAL_REGISTER_SIGNAL_ENTRY                                  = 480,
    TRACE_SIGNAL_REGISTER_SIGNAL_EXIT                                   = 481,
    TRACE_SIGNAL_SIGNAL_THREAD_ENTRY                                    = 482,
    TRACE_SIGNAL_SIGNAL_THREAD_EXIT                                     = 483,

    TRACE_X86_KEYBOARD_ATTACH_ENTRY                                     = 484,
    TRACE_X86_KEYBOARD_ATTACH_EXIT                                      = 485,
    TRACE_X86_KEYBOARD_INT_HANDLER_ENTRY                                = 486,
    TRACE_X86_KEYBOARD_INT_HANDLER_EXIT                                 = 487,
    TRACE_X86_KEYBOARD_READ_ENTRY                                       = 488,
    TRACE_X86_KEYBOARD_READ_EXIT                                        = 489,
    TRACE_X86_KEYBOARD_SET_ECHO                                         = 490,
