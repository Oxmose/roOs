...
#define TEST_KFUTEX_CREATE_THREADS(X) ((X) + 11000)
#define TEST_KFUTEX_JOIN_THREADS(X)   ((X) + 11011)
#define TEST_KFUTEX_ORDER_WAIT_SLEEP(X) ((X) + 11021)
#define TEST_KFUTEX_ORDER_WAIT_WAIT(X)  ((X) + 11031)
#define TEST_KFUTEX_ORDER_WAIT_WAITVAL(X)  ((X) + 11041)
#define TEST_KFUTEX_ORDER_WAIT_SLEEP_WAKE(X) ((X) + 11051)
#define TEST_KFUTEX_ORDER_WAIT_WAKE(X) ((X) + 11061)
#define TEST_KFUTEX_ORDER_WAIT_WAITREASON(X) ((X) + 11071)
#define TEST_KFUTEX_CANCEL_SLEEP0 11081
#define TEST_KFUTEX_CANCEL_SLEEP1 11082
#define TEST_KFUTEX_CANCEL_SLEEP2 11083
#define TEST_KFUTEX_CANCEL_WAIT0 11084
#define TEST_KFUTEX_CANCEL_WAIT1 11085
#define TEST_KFUTEX_CANCEL_WAIT2 11086
#define TEST_KFUTEX_CANCEL_CREATE_THREADS0 11087
#define TEST_KFUTEX_CANCEL_CREATE_THREADS1 11088
#define TEST_KFUTEX_CANCEL_CREATE_THREADS2 11089
#define TEST_KFUTEX_CANCEL_JOIN_THREADS0 11090
#define TEST_KFUTEX_CANCEL_JOIN_THREADS1 11091
#define TEST_KFUTEX_CANCEL_JOIN_THREADS2 11092
#define TEST_KFUTEX_CANCEL_WAKE0 11093
#define TEST_KFUTEX_CANCEL_WAKE1 11094
#define TEST_KFUTEX_MULTIPLE_CREATE_THREADS(X) ((X) + 11095)
#define TEST_KFUTEX_MULTIPLE_SLEEP0 11105
#define TEST_KFUTEX_MULTIPLE_SLEEP1 11106
#define TEST_KFUTEX_MULTIPLE_WAKE 11107
#define TEST_KFUTEX_MULTIPLE_VALUE_RET 11108
#define TEST_KFUTEX_MULTIPLE_WAIT(X) ((X) + 11109)
#define TEST_KFUTEX_MULTIPLE_WAKE1 11119
#define TEST_KFUTEX_MULTIPLE_SLEEP2 11120
#define TEST_KFUTEX_MULTIPLE_VALUE_RET1 11121
#define TEST_KFUTEX_SAMEHANDLE_CREATE_THREADS(X) ((X) + 11122)
#define TEST_KFUTEX_SAMEHANDLE_SLEEP0 11222
#define TEST_KFUTEX_SAMEHANDLE_SLEEP1 11223
#define TEST_KFUTEX_SAMEHANDLE_WAKE 11224
#define TEST_KFUTEX_SAMEHANDLE_VALUE_RET 11225
#define TEST_KFUTEX_SAMEHANDLE_WAIT(X) ((X) + 11226)
#define TEST_KFUTEX_SAMEHANDLE_WAKE1 11326
#define TEST_KFUTEX_SAMEHANDLE_SLEEP2 11327
#define TEST_KFUTEX_SAMEHANDLE_VALUE_RET1 11328
#define TEST_KFUTEX_RELEASE_GET_ID 11329
#define TEST_KFUTEX_RELEASE_CREATE_THREADS(X) ((X) + 11330)
#define TEST_KFUTEX_RELEASE_SLEEP0 11340
#define TEST_KFUTEX_RELEASE_WAKE 11341
#define TEST_KFUTEX_RELEASE_SLEEP1 11342
#define TEST_KFUTEX_RELEASE_VALUE_RET0 11343
#define TEST_KFUTEX_RELEASE_GET_TABLE0 11344
#define TEST_KFUTEX_RELEASE_CREATE_THREADS0 11345
#define TEST_KFUTEX_RELEASE_SLEEP2 11346
#define TEST_KFUTEX_RELEASE_WAKE1 11347
#define TEST_KFUTEX_RELEASE_SLEEP3 11348
#define TEST_KFUTEX_RELEASE_VALUE_RET1 11349
#define TEST_KFUTEX_RELEASE_GET_TABLE1 11350
#define TEST_KFUTEX_RELEASE_WAIT(X) ((X) + 11351)
#define TEST_KFUTEX_CREATE_THREADS0(X) ((X) + 11362)
#define TEST_KFUTEX_JOIN_THREADS0(X)((X) + 11372)


#define TEST_SCHEDULER_TODO 12000

#define TEST_KSEMAPHORE_WAIT_SEM_KMUTEX1(X) ((X) + 13000)
#define TEST_KSEMAPHORE_POST_SEM_KMUTEX1(X) ((X) + 13100)
#define TEST_KSEMAPHORE_CREATE_KSEMAPHORE1  13200
#define TEST_KSEMAPHORE_CREATE_THREADS1(X) ((X) + 13201)
#define TEST_KSEMAPHORE_POST_SEM_KMUTEX0 13301
#define TEST_KSEMAPHORE_JOIN_THREADS1(X) ((X) + 13302)
#define TEST_KSEMAPHORE_KMUTEX_VALUE 13402
#define TEST_KSEMAPHORE_CREATE_THREAD0 13403
#define TEST_KSEMAPHORE_WAIT_SEM_ORDER1(X) ((X) + 13404)
#define TEST_KSEMAPHORE_POST_SEM_ORDER1(X) ((X) + TEST_KSEMAPHORE_WAIT_SEM_ORDER1(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KSEMAPHORE_ORDER_TEST(X) ((X) + TEST_KSEMAPHORE_POST_SEM_ORDER1(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KSEMAPHORE_CREATE_KSEMAPHORE2 (TEST_KSEMAPHORE_ORDER_TEST(KERNEL_LOWEST_PRIORITY + 2) + 1)
#define TEST_KSEMAPHORE_CREATE_THREADS2(X) ((X) + TEST_KSEMAPHORE_CREATE_KSEMAPHORE2 + 1)
#define TEST_KSEMAPHORE_POST_SEM_ORDER0 (TEST_KSEMAPHORE_CREATE_THREADS2(KERNEL_LOWEST_PRIORITY + 2) + 1)
#define TEST_KSEMAPHORE_JOIN_THREADS2(X) ((X) + TEST_KSEMAPHORE_POST_SEM_ORDER0 + 1)
#define TEST_KSEMAPHORE_WAIT_SEM_FIFO1(X) ((X) + TEST_KSEMAPHORE_JOIN_THREADS2(KERNEL_LOWEST_PRIORITY + 2) + 1)
#define TEST_KSEMAPHORE_POST_SEM_FIFO1(X) ((X) + TEST_KSEMAPHORE_WAIT_SEM_FIFO1(KERNEL_LOWEST_PRIORITY + 2) + 1)
#define TEST_KSEMAPHORE_CREATE_KSEMAPHORE3 (TEST_KSEMAPHORE_POST_SEM_FIFO1(KERNEL_LOWEST_PRIORITY + 2) + 1)
#define TEST_KSEMAPHORE_CREATE_THREADS3(X) ((X) + TEST_KSEMAPHORE_CREATE_KSEMAPHORE3 + 1)
#define TEST_KSEMAPHORE_POST_SEM_FIFO0 (TEST_KSEMAPHORE_CREATE_THREADS3(KERNEL_LOWEST_PRIORITY + 2) + 1)
#define TEST_KSEMAPHORE_JOIN_THREADS3(X) ((X) + TEST_KSEMAPHORE_POST_SEM_FIFO0 + 1)
#define TEST_KSEMAPHORE_FIFO_VALUE (TEST_KSEMAPHORE_JOIN_THREADS3(KERNEL_LOWEST_PRIORITY + 2) + 1)
#define TEST_KSEMAPHORE_WAIT_SEM_CANCEL(X) ((X) + 1 + TEST_KSEMAPHORE_FIFO_VALUE)
#define TEST_KSEMAPHORE_CREATE_KSEMAPHORE4 (TEST_KSEMAPHORE_WAIT_SEM_CANCEL(100) + 1)
#define TEST_KSEMAPHORE_CREATE_THREADS4(X) ((X) + 1 + TEST_KSEMAPHORE_CREATE_KSEMAPHORE4)
#define TEST_KSEMAPHORE_POST_SEM_CANCEL0 (1 + TEST_KSEMAPHORE_CREATE_THREADS4(100))
#define TEST_KSEMAPHORE_JOIN_THREADS4(X) ((X) + 1 + TEST_KSEMAPHORE_POST_SEM_CANCEL0)
#define TEST_KSEMAPHORE_WAIT_SEM_TRYPEND1(X) ((X) + 1 + TEST_KSEMAPHORE_JOIN_THREADS4(100))
#define TEST_KSEMAPHORE_POST_TRYPEND1(X) ((X) + 1 + TEST_KSEMAPHORE_WAIT_SEM_TRYPEND1(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KSEMAPHORE_TRYWAIT_TRYPEND1(X) ((X) + 1 + TEST_KSEMAPHORE_POST_TRYPEND1(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KSEMAPHORE_TRYPEND_TEST(X) ((X) + 1 + TEST_KSEMAPHORE_TRYWAIT_TRYPEND1(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KSEMAPHORE_CREATE_KSEMAPHORE5 (1 + TEST_KSEMAPHORE_TRYPEND_TEST(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KSEMAPHORE_CREATE_KSEMAPHORE6 (1 + TEST_KSEMAPHORE_CREATE_KSEMAPHORE5)
#define TEST_KSEMAPHORE_CREATE_THREADS5(X) ((X) + 1 + TEST_KSEMAPHORE_CREATE_KSEMAPHORE6)
#define TEST_KSEMAPHORE_POST_SEM_TRYPEND0 (1 + TEST_KSEMAPHORE_CREATE_THREADS5(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KSEMAPHORE_JOIN_THREADS5(X) ((X) + 1 + TEST_KSEMAPHORE_POST_SEM_TRYPEND0)
#define TEST_KSEMAPHORE_CREATE_KSEMAPHORE7 (1 + TEST_KSEMAPHORE_JOIN_THREADS5(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KSEMAPHORE_POST_MULTIPLE(X) ((X) + 1 + TEST_KSEMAPHORE_CREATE_KSEMAPHORE7)
#define TEST_KSEMAPHORE_WAIT_MULTIPLE(X) ((X) + 1 + TEST_KSEMAPHORE_POST_MULTIPLE(100))
#define TEST_KSEMAPHORE_DESTROY_MULTIPLE (1 + TEST_KSEMAPHORE_WAIT_MULTIPLE(100))

#define TEST_KMUTEX_CREATE_THREAD0 14000
#define TEST_KMUTEX_VALUE 14001
#define TEST_KMUTEX_JOIN_THREADS_EXC0(X) ((X) + TEST_KMUTEX_VALUE + 1)
#define TEST_KMUTEX_UNLOCK_EXC0 (TEST_KMUTEX_JOIN_THREADS_EXC0(100))
#define TEST_KMUTEX_CREATE_THREADS_EXC0(X) ((X) + TEST_KMUTEX_UNLOCK_EXC0 + 1)
#define TEST_KMUTEX_LOCK_EXC0 (TEST_KMUTEX_CREATE_THREADS_EXC0(100) + 1)
#define TEST_KMUTEX_CREATE_KMUTEX_EXC0 (TEST_KMUTEX_LOCK_EXC0 + 1)
#define TEST_KMUTEX_UNLOCK_EXC1(X) ((X) + TEST_KMUTEX_CREATE_KMUTEX_EXC0 + 1)
#define TEST_KMUTEX_LOCK_EXC1(X) ((X) + 1 + TEST_KMUTEX_UNLOCK_EXC1(100))
// 14408
#define TEST_KMUTEX_LOCK_ORDER1(X) ((X) + 1 + TEST_KMUTEX_LOCK_EXC1(100))
#define TEST_KMUTEX_POST_SEM_ORDER1(X) ((X) + 1 + TEST_KMUTEX_LOCK_ORDER1(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KMUTEX_ORDER_TEST(X) ((X) + 1 + TEST_KMUTEX_POST_SEM_ORDER1(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KMUTEX_CREATE_ORDER_KMUTEX (1 + TEST_KMUTEX_ORDER_TEST(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KMUTEX_LOCK_KMUTEX_ORDER0 (1 + TEST_KMUTEX_CREATE_ORDER_KMUTEX)
#define TEST_KMUTEX_CREATE_ORDER_THREAD(X) ((X) + 1 + TEST_KMUTEX_LOCK_KMUTEX_ORDER0)
#define TEST_KMUTEX_UNLOCK_KMUTEX_ORDER0 (1 + TEST_KMUTEX_CREATE_ORDER_THREAD(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KMUTEX_JOIN_ORDER_THREADS(X) ((X) + 1 + TEST_KMUTEX_UNLOCK_KMUTEX_ORDER0)
#define TEST_KMUTEX_LOCK_FIFO1(X) ((X) + 1 + TEST_KMUTEX_JOIN_ORDER_THREADS(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KMUTEX_UNLOCK_FIFO1(X) ((X) + 1 + TEST_KMUTEX_LOCK_FIFO1(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KMUTEX_CREATE_FIFO_KMUTEX (1 + TEST_KMUTEX_UNLOCK_FIFO1(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KMUTEX_LOCK_KMUTEX_FIFO0 (1 + TEST_KMUTEX_CREATE_FIFO_KMUTEX)
#define TEST_KMUTEX_CREATE_FIFO_THREADS(X) ((X) + 1 + TEST_KMUTEX_LOCK_KMUTEX_FIFO0)
#define TEST_KMUTEX_UNLOCK_FIFO0 (1 + TEST_KMUTEX_CREATE_FIFO_THREADS(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KMUTEX_JOIN_FIFO_THREADS(X) ((X) + 1 + TEST_KMUTEX_UNLOCK_FIFO0)
#define TEST_KMUTEX_FIFO_VALUE (1 + TEST_KMUTEX_JOIN_FIFO_THREADS(KERNEL_LOWEST_PRIORITY + 2))
#define TEST_KMUTEX_LOCK_RECUR1(X) ((X) + 1 + TEST_KMUTEX_FIFO_VALUE)
#define TEST_KMUTEX_UNLOCK_RECUR1(X) ((X) + 1 + TEST_KMUTEX_LOCK_RECUR1(10))
#define TEST_KMUTEX_CREATE_KMUTEX_RECUR0 (1 + TEST_KMUTEX_UNLOCK_RECUR1(10))
#define TEST_KMUTEX_CREATE_THREADS_RECUR(X) ((X) + 1 + TEST_KMUTEX_CREATE_KMUTEX_RECUR0)
#define TEST_KMUTEX_JOIN_THREADS_RECUR(X) ((X) + 1 + TEST_KMUTEX_CREATE_THREADS_RECUR(10))
#define TEST_KMUTEX_UNLOCK_ORDER1(X) ((X) + 1 + TEST_KMUTEX_JOIN_THREADS_RECUR(10))
#define TEST_KMUTEX_LOCK_CANCEL1(X) ((X) + 1 + TEST_KMUTEX_UNLOCK_ORDER1(100))
#define TEST_KMUTEX_CREATE_KMUTEX_CANCEL (1 + TEST_KMUTEX_LOCK_CANCEL1(100))
#define TEST_KMUTEX_LOCK_KMUTEX_CANCEL0 (1 + TEST_KMUTEX_CREATE_KMUTEX_CANCEL)
#define TEST_KMUTEX_CREATE_THREADS_CANCEL(X) ((X) + 1 + TEST_KMUTEX_LOCK_KMUTEX_CANCEL0)
#define TEST_KMUTEX_DESTROY_KMUTEX (1 + TEST_KMUTEX_CREATE_THREADS_CANCEL(100))
#define TEST_KMUTEX_JOIN_THREADS_CANCEL(X) ((X) + 1 + TEST_KMUTEX_DESTROY_KMUTEX)
#define TEST_KMUTEX_JOIN_THREADS_TRYLOCK(X) ((X) + 1 + TEST_KMUTEX_JOIN_THREADS_CANCEL(100))
#define TEST_KMUTEX_SYNC_KMUTEX_UNLOCK (1 + TEST_KMUTEX_JOIN_THREADS_TRYLOCK(100))
#define TEST_KMUTEX_CREATE_THREADS_TRYLOCK(X) ((X) + 1 + TEST_KMUTEX_SYNC_KMUTEX_UNLOCK)
#define TEST_KMUTEX_CREATE_KMUTEX_SYNC_TRYLOCK (1 + TEST_KMUTEX_CREATE_THREADS_TRYLOCK(100))
#define TEST_KMUTEX_LOCK_KMUTEX_TRYLOCK_SYNC (1 + TEST_KMUTEX_CREATE_KMUTEX_SYNC_TRYLOCK)
#define TEST_KMUTEX_CREATE_KMUTEX_TRYLOCK (1 + TEST_KMUTEX_LOCK_KMUTEX_TRYLOCK_SYNC)
#define TEST_KMUTEX_TRYLOCK_TEST(X) ((X) + 1 + TEST_KMUTEX_CREATE_KMUTEX_TRYLOCK)
#define TEST_KMUTEX_TRYLOCK_TRYLOCK1(X) ((X) + 1 + TEST_KMUTEX_TRYLOCK_TEST(100))
#define TEST_KMUTEX_UNLOCK_TRYLOCK1(X) ((X) + 1 + TEST_KMUTEX_TRYLOCK_TRYLOCK1(100))
#define TEST_KMUTEX_LOCK_TRYLOCK1(X) ((X) + 1 + TEST_KMUTEX_UNLOCK_TRYLOCK1(100))
#define TEST_KMUTEX_LOCK_KMUTEX_ELEVATION(X) ((X) + 1 + TEST_KMUTEX_LOCK_TRYLOCK1(100))
#define TEST_KMUTEX_ELEVATION_PRIO(X) ((X) + 1 + TEST_KMUTEX_LOCK_KMUTEX_ELEVATION(10))
#define TEST_KMUTEX_UNLOCK_KMUTEX_ELEVATION(X) ((X) + 1 + TEST_KMUTEX_ELEVATION_PRIO(10))
#define TEST_KMUTEX_CREATE_KMUTEX_ELEVATION (1 + TEST_KMUTEX_UNLOCK_KMUTEX_ELEVATION(10))
#define TEST_KMUTEX_CREATE_THREADS_ELEVATION(X) ((X) + 1 + TEST_KMUTEX_CREATE_KMUTEX_ELEVATION)
#define TEST_KMUTEX_JOIN_THREADS_ELEVATION(X) ((X) + 1 + TEST_KMUTEX_CREATE_THREADS_ELEVATION(10))
