...
/** @brief Users can add values starting here */
...
/**
 * @brief Returns a pointer to the current errno variable.
 *
 * @details Returns a pointer to the current errno variable. This function will
 * not work with kernel threads.
 *
 * @return The function returns a pointer to the current errno variable.
 */
int* __geterrno(void);
