...
python3 ../Tools/CIWorkflow/TestValidator.py x86_i386 Kernel/TestFramework/includes/test_groups_debug.json Kernel/TestFramework/includes/test_list.h ../GeneratedFiles/test_file_output.txt
